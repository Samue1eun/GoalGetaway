...
NFL_TEAM_SCHEDULES = env.get("NFL_TEAM_SCHEDULES")
FLIGHT_DATA_KEY = env.get('FLIGHT_DATA_KEY')
AMAEDEUS_API_KEY = env.get('AMAEDEUS_API_KEY')
AMAEDEUS_SECRET_KEY = env.get('AMAEDEUS_SECRET_KEY')
AMAEDEUS_FLIGHT_KEY = env.get('AMAEDEUS_FLIGHT_KEY')
AMAEDEUS_SECRET_KEY_TWO = env.get('AMAEDEUS_SECRET_KEY_TWO')
