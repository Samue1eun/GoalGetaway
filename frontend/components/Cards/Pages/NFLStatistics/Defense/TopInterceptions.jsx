...
const TopInterceptions = () => {
    ...
    useEffect(() => {
        fetch('http://127.0.0.1:8000/api/v1/api_app/top_stats/?season=2024&stat_requested=defensive_interceptions')
            .then(response => response.json())
            .then(data => {
                const topPlayers = data.sort((a, b) => b.defensive_interceptions - a.defensive_interceptions).slice(0, 10);
                        ...
                        {players.map((player, index) => (
                            <div key={player.player.id} className="collapse collapse-arrow bg-base-200 mb-2">
                                ...
                                <div className="collapse-title text-xl font-medium">
                                    {index + 1}. {player.player.first_name} {player.player.last_name} - {player.defensive_interceptions} INTs
                                </div>
                                <div className="collapse-content">
                                    <div className="text-left">
                                        ...
                                        <div className="mt-2">
                                            ...
                                            <p>Interception TDs: {player.interception_touchdowns}</p>
